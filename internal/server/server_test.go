...
import (
	...
	"github.com/joshuaejs/godcls/internal/log"
...
func testUnauthorized(
	...
	produce, err := client.Produce(ctx, &api.ProduceRequest{
		Record: &api.Record{
			Value: []byte("hello unauthorized world"),
		},
	})
	if produce != nil {
